  ...
  return (
    <div className="card bg-base-100 shadow-xl">
      <div className="card-body">
        <h2 className="card-title text-xl mb-4">Today's Prayer Times</h2>
        ...
        <div className="space-y-2">
          {prayers.map((prayer, index) => {
            ...
            return (
              <div
                key={prayer.name}
                className={`flex items-start justify-between p-6 rounded-xl border transition-all duration-200 ${
                  isNext && !isNotPrayer
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    <div className="text-2xl font-arabic font-bold mb-1">
                      {prayer.arabicName}
                    </div>
                    <div className="text-base capitalize font-medium opacity-80">
                      {prayer.name}
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-end space-y-2">
                  <div className="text-3xl font-bold tabular-nums text-right">
                    {prayer.time}
                  </div>
