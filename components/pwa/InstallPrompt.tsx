...
export function InstallPrompt() {
  ...
  useEffect(() => {
    ...
    const wasInstalled = localStorage.getItem('dhikr-app-installed') === 'true'
    ...
    const handleAppInstalled = () => {
      setIsInstalled(true)
      setShowPrompt(false)
      localStorage.setItem('dhikr-app-installed', 'true')
        ...
        <div className="bg-primary text-primary-content rounded-lg p-4 shadow-lg">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h3 className="font-semibold text-sm">Install Dhikr App</h3>
      ...
      <div className="fixed bottom-4 left-4 right-4 z-50">
        <div className="bg-base-200 border border-base-300 rounded-lg p-4 shadow-lg">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h3 className="font-semibold text-base-content">Install Dhikr App</h3>
