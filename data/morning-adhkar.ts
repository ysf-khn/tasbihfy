// Morning Adhkar (أذكار الصباح) - Authentic morning remembrances
export const morningAdhkar = [
  {
    ...
    transliteration: "Asbahna wa asbahal mulku lillah, walhamdu lillah, la ilaha illallah wahdahu la sharika lah, lahul mulku wa lahul hamdu wa huwa 'ala kulli shay'in qadir. Rabbi as'aluka khayra ma fi hadhal yawmi wa khayra ma ba'dahu, wa a'udhu bika min sharri ma fi hadhal yawmi wa sharri ma ba'dahu",
    translation: "We have entered the morning and at this very time all sovereignty belongs to Allah. All praise is for Allah. None has the right to be worshipped except Allah, alone, without any partner. To Him belongs all sovereignty and praise and He is over all things omnipotent. My Lord, I ask You for the good of this day and the good of what follows it, and I seek refuge in You from the evil of this day and the evil of what follows it.",
    count: 1,
  ...
  },
  {
    ...
    translation: "O Allah, You are my Lord, none has the right to be worshipped except You. You created me and I am Your servant. I am upon Your covenant and promise to the best of my ability. I seek refuge in You from the evil of what I have done. I acknowledge Your favor upon me and I acknowledge my sin, so forgive me, for verily none can forgive sins except You.",
    count: 1,
    reference: "Bukhari 6306",
    category: "morning",
    note: "Master of seeking forgiveness (Sayyid al-Istighfar)"
  },
  {
    id: 4,
    ...
    translation: "O Allah, I have entered the morning and I call upon You and upon the bearers of Your Throne, upon Your angels and all creation, to bear witness that surely You are Allah, none has the right to be worshipped except You, alone, without any partner, and that Muhammad is Your servant and Your Messenger.",
    count: 4,
  ...
  },
  {
    ...
    translation: "O Allah, whatever blessing I or any of Your creation have risen upon this morning is from You alone, without partner. So for You is all praise and unto You all thanks.",
    count: 1,
  ...
  },
  {
    ...
    transliteration: "Allahumma inni a'udhu bika minal kufri, wal faqri, wa a'udhu bika min 'adhabil qabri, la ilaha illa ant",
  ...
  },
  {
    ...
    translation: "Allah is sufficient for me. None has the right to be worshipped except Him. I have placed my trust in Him and He is the Lord of the Mighty Throne.",
    count: 7,
  ...
  },
  {
    ...
    translation: "O Ever-Living, O Self-Subsisting and Supporter of all, by Your mercy I seek assistance. Rectify all of my affairs and do not leave me to myself even for the blink of an eye.",
    count: 1,
    reference: "Hakim 2000",
    category: "morning"
  },
  {
    id: 12,
    ...
    translation: "We have entered the morning upon the natural religion of Islam, the word of sincere devotion, the religion of our Prophet Muhammad (peace be upon him), and the way of our father Abraham, upright, Muslim, and he was not of the polytheists.",
    count: 1,
    reference: "Ahmad 15563",
    category: "morning"
  },
  {
    id: 13,
  ...
  },
  {
    ...
    category: "morning",
    note: "Or once with the addition: 100 times for great reward"
  },
  {
    id: 15,
  ...
  },
  {
    ...
    count: 10,
    reference: "Derived from Quran 33:56",
    category: "morning"
  }
];

export const getMorningAdhkarById = (id: number) => {
  return morningAdhkar.find(dhikr => dhikr.id === id);
};

export const getMorningAdhkarByCategory = (category: string) => {
  return morningAdhkar.filter(dhikr => dhikr.category === category);
};