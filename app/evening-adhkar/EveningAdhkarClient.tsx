...
export default function EveningAdhkarClient() {
  ...
  const handleShare = async () => {
    const shareData = {
      ...
      text: "End your day with authentic evening adhkar for protection and peace",
  ...
  const handleStartCounter = (dhikr: typeof eveningAdhkar[0]) => {
    const dhikrData = {
  ...
  const completionPercentage = Math.round((completedItems.size / eveningAdhkar.length) * 100);

  const benefits = [
    {
      icon: ShieldCheckIcon,
      title: "Night Protection",
      description: "Shield yourself from evil and nightmares through the night"
    },
    {
      icon: SparklesIcon,
      title: "Peace & Tranquility",
      description: "Find inner peace and serenity before sleep"
    },
    {
      icon: ClockIcon,
      title: "Best After Asr",
      description: "Ideally recited after Asr prayer before Maghrib"
    },
  ];
    ...
    <div className="min-h-screen bg-base-200">
      ...
      <div className="navbar bg-base-100 shadow-sm">
        ...
        <div className="navbar-center">
          <h1 className="text-xl font-bold">Evening Adhkar</h1>
        </div>
      ...
      <div className="container mx-auto px-4 py-6 max-w-4xl">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex justify-center gap-4 mt-4">
            <div className="badge badge-outline gap-2">
              ...
              {eveningAdhkar.length} Adhkar
            </div>
            <div className="badge badge-outline">After Asr - Maghrib</div>
          </div>
        </div>
        ...
        <div className="card bg-base-100 shadow-lg mb-6">
          <div className="card-body">
            ...
            <p className="text-sm text-base-content/70 mt-2">
              {completedItems.size} of {eveningAdhkar.length} completed
            </p>
          </div>
        </div>
        ...
        <div className="card bg-base-100 shadow-lg mb-6">
          <div className="card-body">
            <h2 className="card-title text-xl mb-4">Benefits of Evening Adhkar</h2>
                  ...
                  {dhikr.count > 1 && (
                    <div className="flex justify-center mb-4">
                      <div className="join">
                        ...
                        <button
                          className={`btn join-item ${isCompleted ? 'btn-success' : 'btn-secondary'}`}
