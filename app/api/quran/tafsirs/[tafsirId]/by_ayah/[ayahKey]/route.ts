...
export async function GET(
  ...
  try {
    ...
    console.log(
      `📡 /api/quran/tafsirs/${tafsirId}/by_ayah/${ayahKey}: Fetching tafsir with params:`,
      queryString
    );
    ...
    const url = `${apiUrl}/tafsirs/${tafsirId}/by_ayah/${ayahKey}${
      queryString ? `?${queryString}` : ""
    }`;
    console.log(
      `📡 /api/quran/tafsirs/${tafsirId}/by_ayah/${ayahKey}: Request URL:`,
      url
    );
    ...
    if (!response.ok) {
      ...
      console.error(
        `❌ /api/quran/tafsirs/${tafsirId}/by_ayah/${ayahKey}: API request failed:`,
        {
    ...
    console.log(
      `✅ /api/quran/tafsirs/${tafsirId}/by_ayah/${ayahKey}: Successfully fetched tafsir:`,
      {
    ...
    const { tafsirId, ayahKey } = await params;
    console.error(
      `❌ /api/quran/tafsirs/${tafsirId}/by_ayah/${ayahKey}: Error:`,
      error
    );
    return Response.json(
      {
