...
export async function GET(request: Request) {
  try {
    ...
    console.log('📡 /api/quran/recitations: Fetching available recitations with params:', queryString);
    ...
    console.log('✅ /api/quran/recitations: Successfully fetched', data.recitations?.length || 0, 'recitations');
