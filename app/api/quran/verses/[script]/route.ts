...
export async function GET(
  ...
  try {
    ...
    console.log(`📡 /api/quran/verses/${script}: Proxying request with params:`, queryString);
    ...
    const url = `${apiUrl}/quran/verses/${script}${queryString ? '?' + queryString : ''}`;
    ...
    console.log(`✅ /api/quran/verses/${script}: Successfully fetched`, data.verses?.length || 0, 'verses');
