...
export async function GET(
  ...
  try {
    ...
    console.log(
      `📡 /api/quran/verses/by_key/${verseKey}: Fetching verse with params:`,
      queryString
    );
    ...
    const url = `${apiUrl}/verses/by_key/${verseKey}${
    ...
    if (!response.ok) {
      ...
      console.error(
        `❌ /api/quran/verses/by_key/${verseKey}: API request failed:`,
        {
    ...
    console.log(
      `✅ /api/quran/verses/by_key/${verseKey}: Successfully fetched verse:`,
      {
