  ...
  try {
    ...
    return new ImageResponse(
      <div style={{
            ...
            backgroundImage: 'linear-gradient(135deg, #1a1a2e 25%, transparent 25%), linear-gradient(225deg, #1a1a2e 25%, transparent 25%), linear-gradient(45deg, #1a1a2e 25%, transparent 25%), linear-gradient(315deg, #1a1a2e 25%, #16213e 25%)',
        ...
        >
          ...
          >
            {['Arabic Text', 'Translation', 'Tafsir', 'Audio'].map((feature) => (
              <div
                key={feature}
                style={{
                  display: 'flex',
